...
переведены, подборки готовы у семи стран из пятнадцати (`CH`, `DK`, `GR`, `IS`,
`NL`, `NO`, `PT`), у остальных восьми (`AL`, `BA`, `BE`, `CY`, `IE`, `LU`, `ME`,
`MK`) ждут исследования (`docs/research/europe-15/`, Фазы 1–2 плана). До него
