...
Android + iOS. Каталог с тех пор вырос до 408 видов по 40 странам, интерфейс
переведён на 33 языка (`.claude/plans/countries-and-languages.md`,
`.claude/plans/post-soviet-countries.md`). Числа проверяются по данным, а не по
