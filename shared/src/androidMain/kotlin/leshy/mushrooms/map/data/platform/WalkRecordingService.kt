...
class WalkRecordingService : Service() {
    ...
    private fun buildNotification(
        ...
        return NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            ...
            // Гриб, а не «указатель на карте»: уведомление про прогулку в этом приложении, а не
            // про местоположение вообще. Значок статус-бара Android перекрашивает в один цвет по
            // альфе — цветным он быть не может в принципе, поэтому это альфа-маска. Гриб, а не
            // логотип продукта: значок один на обе редакции, и логотип пришлось бы разводить по
            // ним (см. androidMain/CLAUDE.md и tools/generate_notification_icon.py).
            .setSmallIcon(R.drawable.notif_ic_mushroom)
            .setOngoing(true)
