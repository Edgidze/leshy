 ...
 * [compose.project.leshy.data.repository.MapStyleCacheRepository]) straight into the platform's
 * native MapLibre HTTP client, short-circuiting any real network fetch of
 * [compose.project.leshy.ui.map.OPEN_FREE_MAP_STYLE_URL] with these exact bytes instead.
 *
