 ...
 * three-way split (`Plurals.kt`: `n == 1` → [compose.project.leshy.i18n.PluralCategory.One],
 * `n % 10 in 2..4 && n % 100 !in 12..14` → [compose.project.leshy.i18n.PluralCategory.Few], else →
 * [compose.project.leshy.i18n.PluralCategory.Many]) — `Zero` and `Other` never fire (the `when` in
