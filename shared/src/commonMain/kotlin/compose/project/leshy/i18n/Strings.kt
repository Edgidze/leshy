...
private fun russianStrings(key: StringKey): String = when (key) {
    ...
    StringKey.SpeciesFormEdibilityLabel -> "Съедобность"
    StringKey.SpeciesFormEdibilityEdible -> "Съедобный"
    StringKey.SpeciesFormEdibilityConditionallyEdible -> "Условно-съедобный"
    StringKey.SpeciesFormEdibilityInedible -> "Несъедобный"
...
private fun englishStrings(key: StringKey): String = when (key) {
    ...
    StringKey.SpeciesFormEdibilityLabel -> "Edibility"
    StringKey.SpeciesFormEdibilityEdible -> "Edible"
    StringKey.SpeciesFormEdibilityConditionallyEdible -> "Conditionally edible"
    StringKey.SpeciesFormEdibilityInedible -> "Inedible"
