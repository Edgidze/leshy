...
private fun russianStrings(key: StringKey): String = when (key) {
    ...
    StringKey.PreparationEmptyList -> "Скачанных областей пока нет"
    StringKey.PreparationDownloadCurrentViewButton -> "Скачать эту область"
    ...
    StringKey.PreparationTileCountLabel -> "Тайлов"
}
...
private fun englishStrings(key: StringKey): String = when (key) {
    ...
    StringKey.PreparationEmptyList -> "No downloaded areas yet"
    StringKey.PreparationDownloadCurrentViewButton -> "Download this area"
    ...
    StringKey.PreparationTileCountLabel -> "Tiles"
}
