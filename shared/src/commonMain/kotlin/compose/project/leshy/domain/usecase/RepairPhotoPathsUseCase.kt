...
import compose.project.leshy.data.platform.repairStalePhotoPath
 ...
 *
 * Called once per [compose.project.leshy.presentation.archive.ArchiveViewModel]/
 * [compose.project.leshy.presentation.map.MapViewModel] lifecycle — cheap no-op once every path
