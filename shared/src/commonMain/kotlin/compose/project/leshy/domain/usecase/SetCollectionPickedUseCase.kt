...
/** Bulk-writes [Category.isPicked][compose.project.leshy.domain.model.Category.isPicked] AND
 * [Category.isActive][compose.project.leshy.domain.model.Category.isActive] for every member of a
