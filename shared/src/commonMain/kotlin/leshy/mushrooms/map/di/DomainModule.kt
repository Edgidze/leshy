...
import leshy.mushrooms.map.domain.usecase.AssignSpeciesToCollectionUseCase
...
val domainModule = module {
    ...
    factory { AssignSpeciesToCollectionUseCase(get()) }
    factory { DeleteUserSpeciesUseCase(get(), get(), get(), get()) }
}
