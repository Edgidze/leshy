...
internal val swedishStrings: Map<StringKey, String> = mapOf(
    ...
    StringKey.SettingsThemeLight to "Ljust",
    StringKey.SettingsThemeDark to "Mörkt",
    ...
    StringKey.CameraPermissionDenied to "Ingen kameraåtkomst. Tillåt den för appen i enhetens inställningar.",
    ...
    StringKey.DataImportRejectedTitle to "Den här filen kan inte importeras",
    StringKey.DataImportRejectedNotArchive to "Detta är inte ett arkiv: filen går inte att läsa som ZIP. Välj ett arkiv exporterat från Leshy.",
    StringKey.DataImportRejectedNotLeshy to "Det är ett ZIP-arkiv, men inte ett Leshy-arkiv: det saknar manifest.json.",
    StringKey.DataImportRejectedNewerFormat to "Arkivet skapades av en nyare version av appen. Uppdatera appen och försök igen.",
    StringKey.DataImportRejectedDamaged to "Arkivet är skadat: delar av innehållet går inte att läsa. Ingenting importerades.",
    StringKey.DataImportRejectedNoWalks to "Arkivet innehåller inga turer — det finns inget att importera.",
