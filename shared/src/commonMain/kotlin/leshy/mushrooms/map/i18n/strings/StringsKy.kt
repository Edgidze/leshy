...
internal val kyrgyzStrings: Map<StringKey, String> = mapOf(
    ...
    StringKey.WelcomeMenuText to
        "Жогорку сол жактагы меню баскычы колдонмонун бардык бөлүмдөрүнүн жана мүмкүнчүлүктөрүнүн тизмесин " +
            "ачат.",
    StringKey.WelcomeConsentTitle to "Колдонуудан мурун",
    StringKey.WelcomeConsentIntro to "Колдонмонун өзүнө өтүүдөн мурун төмөнкү жоболор менен макул болуу зарыл:",
    StringKey.WelcomeConsentImages to
        "Козу карындарды колдонмодогу сүрөттөр боюнча аныктоого аракет кылбайсыз. Сүрөттөр иллюстрация ролун гана " +
            "аткарат жана текшерилген аныктагыч эмес.",
    StringKey.WelcomeConsentEating to
        "Эч кандай учурда өзүңүз билбеген козу карындарды жебейсиз. Козу карындар жегенге жараксыз да, уулуу да " +
            "болушу мүмкүн. Эң жакшысы — өз жериңиздин козу карындарын билген адамды чакырыңыз, ошондо кайсы козу " +
            "карындарды чогултууга болорун жана аларды кийин кантип даярдоо керектигин билесиз.",
    StringKey.WelcomeConsentBattery to
        "Сейилдөө учурунда керектүү коопсуздук эрежелерин сактайсыз жана колдонмо иштеп турганда телефондун заряды " +
            "тезирээк түгөнөрүн эске аласыз. Заряд аз калганда сейилдөөнү жаздырууну токтотуп, колдонмону жапкан " +
            "жакшы.",
    StringKey.WelcomeConsentWarning to
        "Улантуу үчүн жогорудагы жоболор менен макул болуп, өзүңүз макул болгон жоболордун алдына белги коюу зарыл",
