...
internal val croatianStrings: Map<StringKey, String> = mapOf(
    ...
    StringKey.SettingsThemeSystem to "Sustav",
    ...
    StringKey.CameraPermissionDenied to "Nema pristupa kameri. Dopustite ga aplikaciji u postavkama uređaja.",
    ...
    StringKey.DataImportRejectedTitle to "Ovu datoteku nije moguće uvesti",
    StringKey.DataImportRejectedNotArchive to "Ovo nije arhiva: datoteka se ne može pročitati kao ZIP. Odaberite arhivu izvezenu iz Leshyja.",
    StringKey.DataImportRejectedNotLeshy to "Ovo jest ZIP arhiva, ali nije Leshyjeva: u njoj nema manifest.json.",
    StringKey.DataImportRejectedNewerFormat to "Arhivu je stvorila novija verzija aplikacije. Ažurirajte aplikaciju i pokušajte ponovno.",
    StringKey.DataImportRejectedDamaged to "Arhiva je oštećena: dio sadržaja se ne može pročitati. Ništa nije uvezeno.",
    StringKey.DataImportRejectedNoWalks to "U arhivi nema nijedne šetnje — nema se što uvesti.",
