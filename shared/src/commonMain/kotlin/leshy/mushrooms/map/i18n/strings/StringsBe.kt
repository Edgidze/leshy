...
internal val belarusianStrings: Map<StringKey, String> = mapOf(
    ...
    StringKey.WelcomeConsentBattery to
        "Падчас прагулак вы будзеце трымацца неабходнай тэхнікі бяспекі і ўлічваць, што з працуючай праграмай " +
            "тэлефон разраджаецца хутчэй. Пры малым зарадзе запіс прагулкі лепш спыніць, а праграму — закрыць.",
