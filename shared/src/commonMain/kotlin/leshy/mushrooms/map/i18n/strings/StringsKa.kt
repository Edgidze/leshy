...
internal val georgianStrings: Map<StringKey, String> = mapOf(
    ...
    StringKey.WelcomeConsentBattery to
        "გასეირნებისას დაიცავთ საჭირო უსაფრთხოების წესებს და გაითვალისწინებთ, რომ ჩართული აპლიკაციისას ტელეფონის " +
            "ბატარეა უფრო სწრაფად იხარჯება. დაბალი მუხტის დროს სჯობს გასეირნების ჩაწერა შეაჩეროთ, აპლიკაცია კი " +
            "დახუროთ.",
