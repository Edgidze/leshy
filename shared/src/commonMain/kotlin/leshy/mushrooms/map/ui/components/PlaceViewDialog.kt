...
import leshy.mushrooms.map.data.platform.plainTextClipEntry
...
/** Confirmation gate before [DeletePlaceMarkUseCase][leshy.mushrooms.map.domain.usecase.DeletePlaceMarkUseCase]
