...
# Частотность 33 подборок исходной выгрузки. Отдельным файлом, потому что это производные данные:
# их пересобирает этот скрипт из `docs/research/frequency/`, и в дифе тогда видно решение, а не
# его отпечаток внутри 43 тысяч строк источника (сам источник правится прямо, см.
