...
- **Десяти сборок мало в активный день.** 2026-09-03 их было восемь, и
  каталог сборки, по которой уже символизированы отчёты расследования,
  оказался в двух шагах от вытеснения. Правило: символизировал отчёт —
  скопируй каталог сборки в `~/Library/Developer/leshy-symbols-pinned/`,
  ротация туда не лезет. Автоматики нет, скрипт про этот каталог не знает.
